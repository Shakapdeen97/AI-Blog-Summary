...
function Dashboard() {
  ...
  const filteredBlogs = blogs.filter((blog) => {
    ...
    const categoryMatch =
      ...
      blog.tags
        ?.toLowerCase()
        .trim() === selectedCategory.toLowerCase();
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-8 py-10">
        ...
        <div className="mt-10 bg-gradient-to-r from-sky-900 via-sky-800 to-sky-700 rounded-[35px] p-10 shadow-2xl text-white overflow-hidden relative">
          ...
          <div className="absolute -top-20 -right-20 w-72 h-72 bg-sky-400/20 rounded-full blur-3xl">
          </div>
            ...
            <div className="flex justify-between items-start">
              ...
              <div className="flex gap-6">
                ...
                <div className="relative">
                  ...
                  <span className="absolute bottom-1 right-1 w-4 h-4 bg-green-400 rounded-full border-2 border-sky-800">
                  </span>
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="bg-white text-sky-900 px-7 py-3 rounded-2xl font-semibold hover:scale-105 transition"
                >
                  ✍️ Write New
                </button>
